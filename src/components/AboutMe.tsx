export default function AboutMe() {
    ...
    return (
        <div className="mx-auto p-10 border text-center w-full lg:w-1/2 lg:relative lg:bottom-1/4 flex justify-center flex-col lg:my-40  dark:text-white" id="aboutMe">
