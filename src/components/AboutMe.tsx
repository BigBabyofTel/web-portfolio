export default function AboutMe() {
    ...
    return (
        <div className="mx-auto p-5 my-20 text-center w-full rounded-3xl shadow-xl  shadow-[#C38055]  lg:w-1/2 lg:relative lg:bottom-1/4 flex justify-center flex-col lg:my-28 dark:shadow-inner border-2 dark:border-[#571c2e] dark:shadow-[#bf907e] border-[#bf907e] dark:bg-[#571c2e]" id="aboutMe">
        <h2 className="text-4xl lg:text-5xl p-2 m-5 text-[#571cse] dark:text-[#eeb29b] font-serif">About Me</h2>
        <p className="mb-5 flex leading-10 text-[#571c2e] dark:text-[#eeb29b] font-serif text-lg">
        ...
        <p className="flex leading-10 text-[#571c2e] dark:text-[#eeb29b] font-serif text-lg">
