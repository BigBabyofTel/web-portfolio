export default function AboutMe() {
    ...
    return (
        <div className="mx-auto p-5 my-20 text-center w-full rounded-3xl bg-[#C38055] dark:bg-[#c38055] lg:w-1/2 lg:relative lg:bottom-1/4 flex justify-center flex-col lg:my-28 shadow-md shadow-[#bf907e] dark:shadow-[#9bcbd7]" id="aboutMe">
        ...
        <p className="flex leading-10 text-[#AEA8B4] dark:text-[#bf907e]">
